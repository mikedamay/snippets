                                ...
                                <tr>
                                    <td>
                                        <div class="form-check row">
                                            <label class="form-check-label col-10" for="{{feature-name}}">{{feature-tex}}</label>
                                            <input id="{{feature-name}}" data-val="{{feature-name}}" checked type="checkbox" class="form-check-input col-1 exercism-feature"
